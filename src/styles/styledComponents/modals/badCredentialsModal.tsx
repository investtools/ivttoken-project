...
interface BadCredentialsModalProps {
  closeModal: () => void;
}

export default function BadCredentialsModal({ closeModal }: BadCredentialsModalProps) {
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    Oops! We couldn&apos;t submit your responses :(
                  </Dialog.Title>
                  <div className="mt-2">
                    <p className="text-sm text-gray-500 text-center">
                      The key you entered is invalid.<br />
                      Please check that you entered it correctly and try again.<br />
                      If you do not have a valid key, please contact us for more information.
                    </p>
                  </div>
