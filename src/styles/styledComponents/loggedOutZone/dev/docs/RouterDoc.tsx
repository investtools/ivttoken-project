        ...
        <div className="mb-4 hover:scale-110 border-4 border-transparent hover:border-hover transition duration-500 grid card-shadow grid-cols-1 rounded p-6 flex-col justify-between items-start transform">
            <div>
                ...
                <div className='grid grid-cols-2'>
                    {input !== '' ? (<><p className="mb-2"><span className="border-b-2 text-ivtcolor2 font-bold border-ivtcolor2 inline-block">{t.t("Input")}:</span></p><p className='font-extrabold text-hover'>{input}</p></>) : ""}
                    {output !== '' ? (<><p className="mb-2"><span className="border-b-2 text-ivtcolor2 font-bold border-ivtcolor2 inline-block">{t.t("Output")}:</span></p><p className='font-extrabold text-hover'>{output}</p></>) : ""}
