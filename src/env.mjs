...
const processEnv = {
  ...
  NEXT_PUBLIC_REGISTER_SCHOOL_ADMIN_URL: process.env.NEXT_PUBLIC_REGISTER_SCHOOL_ADMIN_URL,
  NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY: process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY,
  CLERK_SECRET_KEY: process.env.CLERK_SECRET_KEY,
  CLERK_FRONTEND_API: process.env.CLERK_FRONTEND_API,
  NEXT_PUBLIC_SLACK_SIGNING_SECRET: process.env.NEXT_PUBLIC_SLACK_SIGNING_SECRET,
  NEXT_PUBLIC_SLACK_BOT_TOKEN: process.env.NEXT_PUBLIC_SLACK_BOT_TOKEN,
  NEXT_PUBLIC_SLACK_CHANNEL: process.env.NEXT_PUBLIC_SLACK_CHANNEL,
