...
interface NothingToApproveModalProps {
  closeModal: () => void
  locale: string
  title: string
}

export default function NothingToApproveModal({ closeModal, locale, title }: NothingToApproveModalProps) {
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    {t.t("Oops! Nothing to approve here...")}
                  </Dialog.Title>
                  <div className="mt-2">
                    <p className="text-sm text-gray-500 text-center">
                      {t.t(`There are currently no pending ${title === 'isp' ? "providers" : "schools"} to approve.`)}<br />
