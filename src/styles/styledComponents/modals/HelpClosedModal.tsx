...
interface HelpClosedModalProps {
  closeModal: () => void
  locale: string
}

export default function HelpClosedModal({ closeModal, locale }: HelpClosedModalProps) {
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500 text-center">
                      {t.t("This help has been successfully closed.")}
                    </p>
                  </div>
