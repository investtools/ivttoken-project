    ...
    public t(string: string) {
        if (this.locale === "pt-br") {
            switch (string) {
                ...
                case "checks if the user already has an account": return ""
                case "checks if the is authorized to login": return ""
                case "gets the role that the user is authorized": return ""
                case "": return ""
                case "": return ""
                case "": return ""
                case "": return ""
